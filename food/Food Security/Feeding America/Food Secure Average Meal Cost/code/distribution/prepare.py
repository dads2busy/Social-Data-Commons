"""Prepare food secure average meal cost data for dashboard sites.

Reads the master working files from Overall Food Insecurity,
filters to Cost_Per_Meal, and writes distribution + dashboard files.
"""
...
log = get_logger("meal_cost.prepare")

MEASURES = {"Cost_Per_Meal"}
...
def run() -> None:
    ...
    ncr_path = write_data(ncr, DIST_DIR / "ncr_ct_fa_2014_2019_food_secure_avg_meal_cost.csv.xz")
    ...
    if dashboard_rel:
        paths = data_reformat_for_site(
            ...
            coverage_area="ncr",
            data_source="fa",
            title="food_secure_avg_meal_cost",
    ...
    va_path = write_data(va, DIST_DIR / "va_hdct_fa_2014_2019_food_secure_avg_meal_cost.csv.xz")
