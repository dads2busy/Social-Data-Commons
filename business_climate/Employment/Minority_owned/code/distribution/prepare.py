"""Prepare Minority owned employment metrics for dashboard sites."""
...
log = get_logger("employment.minority_owned.prepare")
...
def run() -> None:
    ...
    title = "employment_metrics_by_Minority_owned"
