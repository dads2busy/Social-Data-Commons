"""Ingest Business characteristics Minority owned metrics from Mergent Intellect."""
...
log = get_logger("business_chars.minority_owned.ingest")
...
def run() -> RunResult:
    ...
    for prefix, src in config["sources"].items():
        ...
        output, filename = business_dynamics(features, topic, prefix)
