"""Prepare Minority owned business metrics for dashboard sites."""
...
log = get_logger("business_chars.minority_owned.prepare")
...
def run() -> None:
    ...
    title = "business_metrics_by_Minority_owned"
