"""Prepare Industry Minority owned business metrics for dashboard sites."""
...
log = get_logger("business_chars.industry_minority_owned.prepare")
...
def run() -> None:
    ...
    title = "business_metrics_by_Industry_Minority_owned"
