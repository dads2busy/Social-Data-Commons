"""Ingest hospital and emergency room accessibility scores for VA and NCR.

Uses HIFLD hospital locations, ACS total population at block group level,
and pre-computed BG-to-BG travel times to compute 2SFCA, E2SFCA, and 3SFCA
access scores. Each hospital is treated as a single unit (capacity=1) since
no capacity column is available.
"""
