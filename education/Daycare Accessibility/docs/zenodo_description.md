...
Day care availability ratios are calculated using the 3-step floating catchment area (3SFCA) method with quadratic selection-weight normalization (Wan et al., 2012) and Gaussian distance-decay (scale parameter 18/sqrt(2) approx 12.73).
