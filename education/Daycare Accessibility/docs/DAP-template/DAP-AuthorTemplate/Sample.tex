...
\title[Emerging health data platforms]{Emerging health data platforms: From individual control
to collective data governance}

\author*[1]{Timothy Kariotis}\email{timothy.kariotis@unimelb.edu.au}\orcid{0000-0002-8514-4315}
\author[2]{Mad Price Ball}
\author[3]{Bastian Greshake Tzovaras}
\author[1]{Simon Dennis}
\author[2]{Tony Sahama}
\author[3]{Carolyn Johnston}
\author[1]{Ann Borda}

\authormark{Timothy Kariotis \etal}
...
\keywords{data governance; data stewardship; emerging data platforms; health data; person generated health data}

\keywords[Abbreviations]{EHR, Electronic Health Records; EU, European Union; GDPR, General Data Protection Regulation; HRB, Health Record Bank; ODI, Open Data Institute; PLM, Patients Like Me}
...
\bibitem[Freud, 1953]{bib7}
\textbf{Freud S} (1953) \textit{The Method of Interpreting Dreams}, volume~4, pages 96--121.
 American Psychological Association.

\bibitem[Gilbert et~al., 2004]{bib2}
\textbf{Gilbert DG}, \textbf{McClernon JF}, \textbf{Rabinovich NE}, \textbf{Sugai C}, \textbf{Plath LC},
  \textbf{Asgaard G}, \textbf{Dickinson D and Botros N} (2004)
 Effects of quitting smoking and {EEG} activation and attention last
  for more than 31 days and are more severe with stress, dependence, {DRD2 A1}
  allele, and depressive traits. \textit{Nicotine and Tobacco Research} \textit{6}, 249--267.

\bibitem[Herbst-Damm and Kulik, 2005]{bib1}
\textbf{Herbst-Damm KL and Kulik JA} (2005)
Volunteer support, marital status, and the survival times of terminally ill patients.
\textit{Health Psychology} \textit{24}, 225--229.

\bibitem[Light and Light, 2008]{bib3}
\textbf{Light MA and Light IH} (2008)
 The geographic expansion of {M}exican immigration in the {U}nited {S}tates and its implications for local law enforcement. \textit{Law Enforcement Executive Forum Journal} \textit{8}(1), 73--82.

\bibitem[Schiraldi, 2001]{bib5}
\textbf{Schiraldi GR} (2001) \textit{The Post-traumatic Stress Disorder Sourcebook}. Springer.

\bibitem[Shotton, 1989]{bib4}
\textbf{Shotton MA} (1989) \textit{Computer Addiction? {A} Study of Computer Dependency}.  Taylor \& Francis.

\bibitem[VandenBos, 2007]{bib6}
\textbf{VandenBos GR}, editor (2007) \textit{APA Dictionary of Psychology}. American Psychological Association.
\end{thebibliography}
