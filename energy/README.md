...
| ResidentialEnergyScenario | Synthetic VA household population + ResStock load + PV generation + adoption scenarios (4-file integration, 2030) | Ingest landed (no prepare.py yet) |
